...
export const Documents: React.FC = () => {
  ...
  // Data fetching - Filter for document files only
  ...
  return (
    <Layout>
      <div className="space-y-6">
        <PageHeader
          title="Documents"
          subtitle="Manage your document files (PDF, DOC, XLS, etc.)"
        >
        ...
        <Dialog
          ...
          title={
            deleteConfirmation.multiple ? 'Delete Documents' : 'Delete Document'
          }
          message={
            deleteConfirmation.multiple
              ? `Are you sure you want to delete ${selectedFiles.length} selected documents? This action cannot be undone.`
