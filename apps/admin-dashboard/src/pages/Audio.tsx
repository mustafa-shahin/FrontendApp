...
export const Audio: React.FC = () => {
  ...
  // Data fetching - Filter for audio files only
  ...
  return (
    <Layout>
      <div className="space-y-6">
        <PageHeader
          title="Audio"
          subtitle="Manage your audio files (MP3, WAV, FLAC, etc.)"
        >
        ...
        <Dialog
          ...
          message={
            deleteConfirmation.multiple
              ? `Are you sure you want to delete ${selectedFiles.length} selected audio files? This action cannot be undone.`
